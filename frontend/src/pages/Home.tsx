            ...
            {[
              {
                ...
                description: "Cria e organiza equipas Scrum com papéis definidos (Scrum Master, Product Owner, Developer)"
              },
              {
                icon: <Trophy className="w-8 h-8" />,
                title: "Sistema de Prémios",
                description: "Atribui prémios manuais ou automáticos baseados em critérios de desempenho e conquistas"
              },
              {
                icon: <TrendingUp className="w-8 h-8" />,
                title: "Rankings e Dashboards",
                description: "Visualiza progresso individual e de equipa com gráficos e rankings em tempo real"
              },
              {
                icon: <Target className="w-8 h-8" />,
                title: "Gestão de Sprints",
                description: "Acompanha objetivos, prazos e métricas de progresso de cada sprint do projeto"
              },
              {
                icon: <Award className="w-8 h-8" />,
                title: "Pontuação Global",
                description: "Acumula pontos ao longo do curso e compara com médias da turma"
              },
              {
                icon: <CheckCircle className="w-8 h-8" />,
                title: "Avaliação Facilitada",
                description: "Exporta resultados para CSV/Excel e auxilia professores na avaliação final"
              }
            ].map((feature, i) => (
              <div
                key={i}
      ...
      <section id="como-funciona" className="py-20 px-4 bg-gradient-to-br from-indigo-50 to-purple-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Simples, intuitivo e eficaz em 4 passos
            </p>
          </div>
