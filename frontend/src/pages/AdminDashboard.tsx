...
export default function AdminDashboard() {
  ...
  const [stats, setStats] = useState({
    ...
    totalProfessores: 0,
    totalAlunos: 0,
    totalProjetos: 8 // mantém estático pra já
  })
  ...
  // Vai buscar cursos e utilizadores ao backend
  useEffect(() => {
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Bem-vindo! Aqui pode gerir todos os cursos e visualizar estatísticas do sistema.
        </p>
      </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 text-left">
                  ...
                  <th className="pb-3 font-semibold text-gray-700 text-center">Alunos</th>
                  <th className="pb-3 font-semibold text-gray-700 text-center">Professores</th>
                  <th className="pb-3 font-semibold text-gray-700 text-right">Ações</th>
                </tr>
              </thead>
                    ...
                    <td className="py-4">
                      <div className="flex justify-end gap-2">
                        <Button variant="outline" size="sm" onClick={() => {
                                setCursoEditar(curso); // preenche os dados do curso
                                setShowCreateModal(true); // reutilizamos o mesmo modal
                            }}
                            >
